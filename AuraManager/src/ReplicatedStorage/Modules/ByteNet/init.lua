-- This file includes code from ByteNet (Copyright 2025 ffrostfall) under the MIT License.
local RunService = game:GetService("RunService")

if RunService:IsClient() and not game:IsLoaded() then repeat task.wait() until game:IsLoaded() end
